defmodule AppKit.Workspace.SchemaRegistry do
  ...
  @entries [
    ...
    %{
      ...
      dto_packet_table_resource_names: [
        "AppKit.Core.GovernedEffectProposalDTO",
        "AppKit.Core.GovernedEffectDTO",
        "AppKit.Core.EffectReviewDTO",
        "AppKit.Core.EffectReceiptDTO",
        "AppKit.Core.EffectAmbiguityDTO",
        "AppKit.Core.EffectContinuationDTO",
        "AppKit.Core.EffectCleanupDTO",
        "AppKit.Core.EffectDispatchCommandDTO",
        "AppKit.Core.EffectAcceptanceDTO",
        "AppKit.Core.EffectReceiptCommandDTO"
      ],
      required_fields:
        @enterprise_fields ++
          [
