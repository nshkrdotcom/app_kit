# AppKit Mezzanine Bridge Persistence

## Scope

AppKit Mezzanine Bridge owns bridge projection consumer and lower boundary adapter owner. This document is package-local and is the persistence contract for `bridges/mezzanine_bridge` in `app_kit`.
